...
\begin{onecolentry}
    ...
    \begin{highlights}
        \item Guia telefônico virtual onde usuários criam seus próprios contatos composto por backend, frontend web, mobile e plataforma desktop (Python, Flask, PostgreSQL, TypeScript, React, React Native);
        \item Aplicativo mobile que monitora a localização dos entregadores de jornais e notifica ao cliente quando o jornal está próximo de ser entregue (TypeScript, Express.js, PostgreSQL, React Native).
    \end{highlights}
\end{onecolentry}
